...
class BertForDocClassification(BertPreTrainedModel):
    ...
    def forward(self, input_ids, max_seqs_per_doc=150, token_type_ids=None, attention_mask=None, labels=None,
...
#         prob = torch.cat([1-prob,prob], dim=1)
        ...
        outputs = (prob, pooled_output) + outputs[2:]  # add hidden states and attention if they are here
